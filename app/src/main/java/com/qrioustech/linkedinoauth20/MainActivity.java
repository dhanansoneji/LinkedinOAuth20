...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String API_KEY = "8187fioq4f6lng";
    //This is the private api key of our application
    private static final String SECRET_KEY = "TnpaYzt75Gbv5HRZ";
    //This is any string we want to use. This will be used for avoid CSRF attacks. You can generate one here: http://strongpasswordgenerator.com/
    private static final String STATE = "E3ZYKC1T6H2yP4z";
    //This is the url that LinkedIn Auth process will redirect to. We can put whatever we want that starts with http:// or https:// .
    //We use a made up url that we will intercept when redirecting. Avoid Uppercases.
    private static final String REDIRECT_URI = "http://nutrilife.io/nutrilife/public/linkedin/callback";
    /*********************************************/
    ...
    private static final String SCOPE_VALUE = "r_liteprofile%20r_emailaddress%20w_member_social%20r_basicprofile";
    ...
    private static String getAuthorizationUrl(){
        return AUTHORIZATION_URL
                ...
                +AMPERSAND+SCOPE+EQUALS+SCOPE_VALUE;
    }
//    private static String getAuthorizationUrl(){
//        return AUTHORIZATION_URL
//                +QUESTION_MARK+RESPONSE_TYPE_PARAM+EQUALS+RESPONSE_TYPE_VALUE
